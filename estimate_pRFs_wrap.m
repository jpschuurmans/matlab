...
func_name = 'sub-01_ses-01_task-prfBars_run-1_space-T1w_desc-preproc_bold.nii.gz';
stat_name = 'tstat1.nii.gz';
pa_map_outname = 'pa_from_pRF';
ecc_map_outname = 'ecc_from_pRF';
bars_pa_map_outname = 'pa_from_bars_pRF';
bars_ecc_map_outname = 'ecc_from_bars_pRF';
...
tstat_info_ni.Filename = [data_dir, bars_pa_map_outname, '.nii'];
niftiwrite(single(theta), [data_dir, bars_pa_map_outname], tstat_info_ni);

tstat_info_ni.Filename = [data_dir, bars_ecc_map_outname, '.nii'];
niftiwrite(single(rho), [data_dir, bars_ecc_map_outname], tstat_info_ni);
